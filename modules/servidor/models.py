...
class VistaSincronizacion(models.Model):
    ...
    ultima_venta = CustomDateTimeField(verbose_name="Ultima Venta", null=False, blank=False, is_sortable=True, is_searchable=True)
    ultima_sincronizacion = CustomDateTimeField(verbose_name="Ultima Sincronización", null=False, blank=False, is_sortable=True, is_searchable=True)
